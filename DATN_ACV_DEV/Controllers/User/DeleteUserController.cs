...
namespace DATN_ACV_DEV.Controllers.User
{
    ...
    [ApiController]
    public class DeleteUserController : ControllerBase, IBaseController<DetailUserRequest, DetailUserResponse>
    {
        ...
        private string _apiCode = "DeleteUser";
        private TbUser _User;
        public DeleteUserController(DBContext context)
        {
            _context = context;
