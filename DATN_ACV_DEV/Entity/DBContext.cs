...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ADMIN-PC\\SQLEXPRESS;Initial Catalog=DB_DraftBracnh_04_03;Integrated Security=True;Trust Server Certificate=True; Encrypt=False;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<TbCartDetail>(entity =>
        {
            ...
            entity.HasIndex(e => e.CartId, "IX_tb_CartDetail_CartID");

            entity.HasIndex(e => e.ProductId, "IX_tb_CartDetail_ProductID");
