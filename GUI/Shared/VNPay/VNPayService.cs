...
namespace GUI.Shared.VNPay
{
    public class VNPayService
    {
        ...
        public string SendRequest(string ipAddr, string orderId, decimal totalAmount, string bankCode = "")
        {
            ...
            vnpay.AddRequestData("vnp_Amount", ((int)(order.Amount * 100)).ToString()); //Số tiền thanh toán. Số tiền không mang các ký tự phân tách thập phân, phần nghìn, ký tự tiền tệ. Để gửi số tiền thanh toán là 100,000 VND (một trăm nghìn VNĐ) thì merchant cần nhân thêm 100 lần (khử phần thập phân), sau đó gửi sang VNPAY là: 10000000
